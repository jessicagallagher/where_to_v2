  ...
  return (
    <div className='bg-white overflow-hidden shadow sm:rounded-lg w-full'>
      <div className='px-4 py-5 sm:p-6 relative'>
        ...
        <button type='button' className='absolute py-2 left-2/3 bottom-1/3 border border-teal-100 bg-transparent text-base font-medium rounded-md text-dkGrey-100 hover:border-purple-100 w-36'>Create an Account</button>
      </div>
