    ...
    <div>
      ...
      <div className='h-screen flex overflow-hidden bg-white'>
        <div className='fixed inset-0 flex z-40 lg:hidden' role='dialog' aria-modal='true'>
          ...
          transform ${
            open ? 'translate-x-0 ease-out transition-medium' : '-translate-x-full ease-in transition-medium'
          }`}>
            <div className='absolute top-0 right-0 -mr-12 pt-2'>
              <button type='button' className='ml-1 flex items-center justify-center h-10 w-10 rounded-full focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white' onClick={handleClick}>
